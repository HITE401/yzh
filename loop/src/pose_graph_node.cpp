...
ros::Publisher pub_match_img,  pub_camera_pose_visual, pub_point_cloud, pub_margin_cloud, pub_odometry_rect;
...
int main(int argc, char **argv)
{
    ...
    if(argc != 2)
    {
        printf("please intput: rosrun loop_fusion loop_fusion_node [config file] \n"
               ...
               "/home/yzh/catkin_ws/src/vloam_demo/config/kitti/kitti_config00-02.yaml \n");
        return 0;
    }
    ...
    posegraph.setIMUFlag(USE_IMU);      //决定4DOF优化还是6DOF优化
    fsSettings.release();
    ...
    ros::Subscriber sub_vio = n.subscribe("/estimator_node/odometry", 2000, vio_callback);
    ros::Subscriber sub_image = n.subscribe(IMAGE_TOPIC, 2000, image_callback);
    ros::Subscriber sub_pose = n.subscribe("/vins_estimator/keyframe_pose", 2000, pose_callback);
    ros::Subscriber sub_extrinsic = n.subscribe("/vins_estimator/extrinsic", 2000, extrinsic_callback);
    ros::Subscriber sub_point = n.subscribe("/estimator_node/keyframe_point", 2000, point_callback);
